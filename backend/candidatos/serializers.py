...
class DomicileSerializer(serializers.ModelSerializer):
    address_road = serializers.CharField(required=False, allow_blank=True)
    address_number = serializers.CharField(required=False, allow_blank=True)
    address_number_int = serializers.CharField(required=False, allow_blank=True)
    address_PC = serializers.CharField(required=False, allow_blank=True)
    address_municip = serializers.CharField(required=False, allow_blank=True)
    address_col = serializers.CharField(required=False, allow_blank=True)
...
class CandidateCreateSerializer(serializers.ModelSerializer):
    ...
    address_number_int = serializers.CharField(write_only=True, required=False, allow_blank=True)
    address_PC = serializers.CharField(write_only=True, required=False, allow_blank=True)
    address_municip = serializers.CharField(write_only=True, required=False, allow_blank=True)
    address_col = serializers.CharField(write_only=True, required=False, allow_blank=True)
