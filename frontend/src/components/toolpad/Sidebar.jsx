  ...
  useEffect(() => {
    ...
    const setActiveItem = () => {
      ...
      const pathMap = {
        ...
        '/apoyos-evaluacion-diagnostica': 'Evaluación Diagnóstica',
        '/apoyos-cuadro-habilidades': 'Cuadro de Habilidades',
        '/apoyos-SIS': 'SIS',
          ...
          <Box>
            ...
            >
              <Item
                ...
                to="/apoyos/evaluacion-diagnostica"
                selected={selected}
              />
              <Item
                title="Cuadro de Habilidades"
                to="/apoyos/cuadro-habilidades"
                selected={selected}
              />
              <Item
                title="SIS"
              ...
              <>
                ...
                >
                  <Item
                    ...
                    to="/baseCuestionarios"
                    selected={selected}
                  />
                  <Item
                    title="Tablas de equivalencia"
                    to="/tablas-de-equivalencia"
                    selected={selected}
                  />
                </SubMenu>
