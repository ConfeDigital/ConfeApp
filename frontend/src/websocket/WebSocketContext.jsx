 ...
 * @returns {{ isWsConnected: boolean, isWsConnecting: boolean, isProviderInitializing: boolean, forceReconnect: function }} The WebSocket connection status and connecting state.
 */
